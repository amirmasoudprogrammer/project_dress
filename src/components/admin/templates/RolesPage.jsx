...
function RolesPage(props) {
    ...
    return (
        <div className="mt-28 z-10">
            <div>
                <span className="text-black mr-8 text-[25px] font-bold">مدیریت نقش ها</span>
            </div>
            ...
            <div className="mt-10">
                ...
                >
                    ...
                    <tr className="text-center">
                        <td className="px-1 py-1 text-[12px]">admin</td>
                    ...
                    <tr className="text-center">
                        <td className="px-1 py-1 text-[12px]">manager</td>
                        <td className="px-1 py-1 text-[12px]">-</td>
                        <td className="px-1 py-1  text-[12px]">web</td>
                        <td className="flex items-center justify-center text-[19px]">
                            <Link href=""
                    ...
                    <tr className="text-center">
                        <td className="px-1 py-1 text-[12px]">user</td>
                        <td className="px-1 py-1 text-[12px]">-</td>
                        <td className="px-1 py-1  text-[12px]">web</td>
                        <td className="flex items-center justify-center text-[19px]">
                            <Link href=""
