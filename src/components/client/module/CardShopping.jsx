        ...
        <>
            <div className="hidden md:flex items-center rounded border border-slate-400 h-[132px] p-5 mt-5">
                ...
                <div className="flex flex-col items-center justify-center mr-5 ">
                    <span className="text-[#626262] text-[14px] mr-5 mb-5">{Text(item?.title)}</span>
                ...
                <div className="text-sm flex text-[#626262] items-center mr-auto">
                    <span className="ml-2">{ConvertCurrency(item.price)}</span>
                    <span>تومان</span>

                </div>
                <div className="flex justify-around rounded w-[87px] h-[42px] items-center mr-auto border border-slate-400">
            ...
            <div className=" flex flex-col md:hidden rounded-lg border border-slate-200 mt-5 w-[312px] h-[225px] m-auto pt-5 pr-5 pl-5">
                ...
                <div className="mt-3">
                    ...
                    <div className=" flex justify-between mt-5">
                        ...
                        <div className="border border-slate-400 w-[63px] flex items-center rounded justify-around h-[26px]">
                            <button className="text-black" type="submit"
                                    onClick={() => dispatch(increase({
                                        id: item.id,
                                        color: item.colors ?? '',
