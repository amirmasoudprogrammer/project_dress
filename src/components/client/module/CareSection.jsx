...
function CareSection({ imageSrc }) {
    ...
    return (
        <div className="flex flex-col mt-16 border-[#626262] border-b pb-5 mr-2 ml-2 md:ml-0 md:mr-0">
            ...
            >
                <Image src={imageSrc.image_path} width={666} height={596} alt="تصویر" />
            </motion.div>
            ...
            >
                <span className="font-medium text-black text-[14px]">
                    ...
                    <motion.div
                        ...
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 1, delay: 0.3 + imageSrc.id * 0.2 }}
                    >
                        <span className="font-medium text-black text-[14px]">{imageSrc.description}</span>
                        <p className="font-medium text-black text-[14px]">{imageSrc.description}</p>
                    </motion.div>
            </motion.div>
        </div>
    );
