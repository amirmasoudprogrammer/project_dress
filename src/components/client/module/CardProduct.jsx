        ...
        <div className="flex flex-col mt-5">
            <div className="flex flex-col items-center w-auto justify-center border border-slate-300">
                <div className="relative flex flex-col items-center">
                    ...
                    <Image src={category.image } alt={name || "محصول بدون نام"} width={288} height={288}/>
                    <div className="absolute bottom-5 -left-10 md:left-4  flex items-center justify-between w-[140px]">
                        <Link href={`/Products/${id}`} className="shadow-lg text-2xl text-black bg-slate-200 w-7 h-7 flex items-center justify-center p-2 rounded-full">+</Link>
                    </div>
                </div>
            </div>
            <div className="w-full h-[113px] flex flex-col items-start border border-slate-300 p-4">
                <div className="flex items-center justify-between ">
                    ...
                    <span className="text-black dark:text-white mr-5 truncate">{name}</span>
                </div>
