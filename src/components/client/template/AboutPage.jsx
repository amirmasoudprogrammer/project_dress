                ...
                <div className="flex flex-col-reverse md:flex-row items-start justify-between mt-10">
                    ...
                    <div className="flex items-start">
                        <div className="text-black md:mr-16 ">
                            ...
                            <ul>
                                <li className="mt-2"><Link href="@/components/client/template/AboutPage" className="text-[14px] font-medium">تماس با ما</Link></li>
                                <li className="mt-2"><Link href="@/components/client/template/AboutPage" className="text-[14px] font-medium">محصولات ما</Link></li>
                                <li className="mt-2"><Link href="@/components/client/template/AboutPage" className="text-[14px] font-medium">ورود وثبت نام</Link></li>
                                <li className="mt-2"><Link href="@/components/client/template/AboutPage" className="text-[14px] font-medium">درباره ما</Link></li>
                                <li className="mt-2"><Link href="@/components/client/template/AboutPage" className="text-[14px] font-medium">وبلاگ</Link></li>
                            </ul>
                        </div>
                        <div className="text-black mr-16">
                            <span className="text-[16px]">آخرین مطالب وبلاگ</span>
                            <ul>
                                <li className="mt-2"><Link href="@/components/client/template/AboutPage" className="text-[14px] font-medium">تیم کارکنان</Link></li>
                                <li className="mt-2"><Link href="@/components/client/template/AboutPage" className="text-[14px] font-medium">درخواست همکاری</Link></li>
                                <li className="mt-2"><Link href="@/components/client/template/AboutPage" className="text-[14px] font-medium">فروشگاه ما</Link></li>
                                <li className="mt-2"><Link href="@/components/client/template/AboutPage" className="text-[14px] font-medium">محصولات ما</Link></li>
